...
(function() {
  ...
  function initializeSelects() {
    ...
    searchInputs.forEach(searchInput => {
      ...
      dropdown.setAttribute('data-custom-select-dropdown', '');
      
      const optionsList = document.createElement('ul');
      optionsList.setAttribute('data-location-options', '');
      ...
      searchInput.addEventListener('input', (e) => {
        ...
        // Show dropdown
        dropdown.setAttribute('data-display-block', '');
        dropdown.removeAttribute('data-display-none');
      ...
      async function fetchLocations(searchTerm) {
        try {
          ...
          if (data.length > 0) {
            // Add all locations to both datalist and dropdown
            data.forEach(place => {
              // Add to datalist
      ...
      function addOptionListeners() {
        ...
        log('Adding listeners to', options.length, 'options');
      ...
      function handleOptionSelection(option) {
        log('Option selected:', option.textContent);
        ...
        // Hide dropdown
        dropdown.setAttribute('data-display-none', '');
        dropdown.removeAttribute('data-display-block');
